...
export default function App() {
  ...
  const handleBuildGraph = async () => {
    try {
      const res = await axios.post("https://exciting-exploration-production.up.railway.app/build-graph", {
        source,
        destination,
      });
      ...
      if (newRoutes.length > 1) {
        ...
        await await axios.post("https://exciting-exploration-production.up.railway.app/generate-map", {
        ...
        <div className="flex flex-wrap gap-6 justify-center">
          ...
          {routes.length > 1 && (
            <div className="w-full mt-10 border border-green-300 rounded-xl shadow-lg p-4 bg-green-50">
              ...
              {mapReady && (
                <iframe
                  src="https://exciting-exploration-production.up.railway.app/static/multi_route_visualized.html"
                  width="100%"
                  height="600"
